...
def procesar_videoAYFDC(video_front_path):
        ...
        try:
            while cap_front.isOpened():
                ...
                if results_front.pose_landmarks:
                    ...
                    # Puntos para los tobillos y la cadera
                    ...
                    mid_hip_x = (right_hip.x + left_hip.x) / 2
                    mid_hip_y = (right_hip.y + left_hip.y) / 2

                    # Calcula el ángulo entre los tobillos con la cadera como punto central
                    vector1 = (left_ankle.x - mid_hip_x, left_ankle.y - mid_hip_y)
                    vector2 = (right_ankle.x - mid_hip_x, right_ankle.y - mid_hip_y)
