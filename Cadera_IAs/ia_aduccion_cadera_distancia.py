...
class IAAduccionCaderaDistancia:
    def __init__(self, archivo_angulos, archivo_resultados, epocas=600):
        ...
        self.resultados = pd.read_excel(archivo_resultados, usecols=['ADCD_res']).to_numpy(dtype=float).flatten()
