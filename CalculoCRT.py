...
def procesar_videoCRT(video_front_path, video_side_path):
    ...
    # Inicializa el modelo de seguimiento de postura
    frontal_angles_left = []
            ...
            while cap_front.isOpened() or cap_side.isOpened():
                ...
                if success_front:
                    ...
                    if results_front.pose_landmarks:
                        ...
                        # Calcula el ángulo para la pierna izquierda
                        vector1_left = (left_knee.x - left_hip.x, left_knee.y - left_hip.y)
                        vector2_left = (left_ankle.x - left_hip.x, left_ankle.y - left_hip.y)
                        ...
                        # Calcula el ángulo para la pierna derecha
                        vector1_right = (right_knee.x - right_hip.x, right_knee.y - right_hip.y)
                        vector2_right = (right_ankle.x - right_hip.x, right_ankle.y - right_hip.y)
