...
def procesar_video_extension_hombro_distancia_derecha(video_front_path):
    return procesar_video(video_front_path, mp.solutions.pose.PoseLandmark.RIGHT_SHOULDER, mp.solutions.pose.PoseLandmark.RIGHT_WRIST)
