...
def procesar_video_flexion_hombro_distancia_izquierda(video_front_path):
    return procesar_video_vertical(video_front_path, mp.solutions.pose.PoseLandmark.LEFT_HIP, mp.solutions.pose.PoseLandmark.LEFT_WRIST)
